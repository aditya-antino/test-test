...
export { default as livingRoomBanner } from './living_room_banner_image.svg';
export { default as photographyBanner } from './photography_banner_image.jpg';
export { default as podcastBanner } from './podcast_banner_image.png';
export { default as wellnessBanner } from './wellness_banner_image.webp';
export { default as workshopsBanner } from './workshop_banner_image.jpg';
export { default as easyDiscovery } from './icons/easy_discovery.svg';
export { default as noAIPics } from './icons/no_ai_images.svg';
